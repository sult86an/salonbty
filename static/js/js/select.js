...
!function (e, t) {
    ...
    x.fn = x.prototype = {
        ...
        for ("boolean" == typeof a && (c = a, a = arguments[s] || {}, s++), "object" == typeof a || g(a) || (a = {}), s === l && (a = this, s--); s < l; s++) if (null != (e = arguments[s])) for (t in e) n = a[t], a !== (i = e[t]) && (c && i && (x.isPlainObject(i) || (o = Array.isArray(i))) ? (o ? (o = !1, r = n && Array.isArray(n) ? n : []) : r = n && x.isPlainObject(n) ? n : {}, a[t] = x.extend(c, r, i)) : void 0 !== i && (a[t] = i));
        return a
    }, x.extend({
    ...
    var C = function (e) {
        var t, n, i, o, r, a, s, l, c, u, d, h, f, p, g, m, v, y, b, x = "sizzle" + 1 * new Date, w = e.document, k = 0,
            C = 0, _ = ae(), S = ae(), T = ae(), E = function (e, t) {
                return e === t && (d = !0), 0
            }, A = {}.hasOwnProperty, P = [], D = P.pop, I = P.push, O = P.push, M = P.slice, L = function (e, t) {
            ...
            j = "\\[" + R + "*(" + F + ")(?:" + R + "*([*^$|!~]?=)" + R + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + F + "))|)" + R + "*\\]",
            $ = ":(" + F + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + j + ")*)|.*)\\)|)",
            W = new RegExp(R + "+", "g"), H = new RegExp("^" + R + "+|((?:^|[^\\\\])(?:\\\\.)*)" + R + "+$", "g"),
            B = new RegExp("^" + R + "*," + R + "*"), V = new RegExp("^" + R + "*([>+~]|" + R + ")" + R + "*"),
            z = new RegExp("=" + R + "*([^\\]'\"]*?)" + R + "*\\]", "g"), q = new RegExp($),
            Y = new RegExp("^" + F + "$"), X = {
                ID: new RegExp("^#(" + F + ")"),
                CLASS: new RegExp("^\\.(" + F + ")"),
                TAG: new RegExp("^(" + F + "|[*])"),
            ...
            }, U = /^(?:input|select|textarea|button)$/i, K = /^h\d$/i, Q = /^[^{]+\{\s*\[native \w/,
            G = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, Z = /[+~]/,
        ...
        try {
            O.apply(P = M.call(w.childNodes), w.childNodes), P[w.childNodes.length].nodeType
        } catch (e) {
            O = {
        ...
        for (t in n = re.support = {}, r = re.isXML = function (e) {
            ...
            }, v = [], m = [], (n.qsa = Q.test(f.querySelectorAll)) && (le(function (e) {
            ...
            if ((e.ownerDocument || e) !== f && h(e), t = t.replace(z, "='$1']"), n.matchesSelector && g && !T[t + " "] && (!v || !v.test(t)) && (!m || !m.test(t))) try {
                var i = y.call(e, t);
        ...
        function we(e, t, n, i, o, r) {
            return i && !i[x] && (i = we(i)), o && !o[x] && (o = we(o, r)), se(function (r, a, s, l) {
                var c, u, d, h = [], f = [], p = a.length, g = r || function (e, t, n) {
                    ...
                    v = n ? o || (r ? e : p || i) ? [] : a : m;
                if (n && n(m, v, s, l), i) for (c = xe(v, f), i(c, [], s, l), u = c.length; u--;) (d = c[u]) && (v[f[u]] = !(m[f[u]] = d));
                if (r) {
                    if (o || e) {
                        if (o) {
                        ...
                        for (u = v.length; u--;) (d = v[u]) && (c = o ? L(r, d) : h[u]) > -1 && (r[c] = !(a[c] = d))
                    }
                } else v = xe(v === a ? v.splice(p, v.length) : v), o ? o(null, a, v, l) : O.apply(a, v)
            })
        }

        function ke(e) {
            for (var t, n, o, r = e.length, a = i.relative[e[0].type], s = a || i.relative[" "], l = a ? 1 : 0, u = ye(function (e) {
                return e === t
            }, s, !0), d = ye(function (e) {
                return L(t, e) > -1
                ...
                if ((n = i.filter[e[l].type].apply(null, e[l].matches))[x]) {
                    ...
                    return we(l > 1 && be(h), l > 1 && ve(e.slice(0, l - 1).concat({value: " " === e[l - 2].type ? "*" : ""})).replace(H, "$1"), n, l < o && ke(e.slice(l, o)), o < r && ke(e = e.slice(o)), o < r && ve(e))
                }
                h.push(n)
            }
            return be(h)
        ...
        function Ce(e, t) {
            var n = t.length > 0, o = e.length > 0, r = function (r, a, s, l, u) {
                var d, p, m, v = 0, y = "0", b = r && [], x = [], w = c, C = r || o && i.find.TAG("*", u),
                    _ = k += null == w ? 1 : Math.random() || .1, S = C.length;
                for (u && (c = a === f || a || u); y !== S && null != (d = C[y]); y++) {
                    if (o && d) {
                ...
                if (v += y, n && y !== v) {
                    ...
                    O.apply(l, x), u && !r && x.length > 0 && v + t.length > 1 && re.uniqueSort(l)
                }
                return u && (k = _, c = w), b
            };
            return n ? se(r) : r
        ...
        return me.prototype = i.filters = i.pseudos, i.setFilters = new me, a = re.tokenize = function (e, t) {
            ...
            for (s = e, l = [], c = i.preFilter; s;) {
                for (a in n && !(o = B.exec(s)) || (o && (s = s.slice(o[0].length) || s), l.push(r = [])), n = !1, (o = V.exec(s)) && (n = o.shift(), r.push({
                    value: n,
                    type: o[0].replace(H, " ")
            ...
            if (n = n || [], 1 === f.length) {
                ...
                for (r = X.needsContext.test(e) ? 0 : l.length; r-- && (c = l[r], !i.relative[u = c.type]);) if ((d = i.find[u]) && (o = d(c.matches[0].replace(J, ee), Z.test(l[0].type) && ge(t.parentNode) || t))) {
    ...
    x.filter = function (e, t, n) {
        ...
        find: function (e) {
            ...
            return !!P(this, "string" == typeof e && T.test(e) ? x(e) : e || [], !1).length
        }
    });
    var D, I = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
    ...
    x.fn.extend({
        has: function (e) {
            ...
            if (!T.test(e)) for (; i < o; i++) for (n = this[i]; n && n !== t; n = n.parentNode) if (n.nodeType < 11 && (a ? a.index(n) > -1 : 1 === n.nodeType && x.find.matchesSelector(n, e))) {
                r.push(n);
                break
            }
        ...
        x.fn[e] = function (n, i) {
            ...
            return "Until" !== e.slice(-5) && (i = n), i && "string" == typeof i && (o = x.filter(i, o)), this.length > 1 && (M[e] || x.uniqueSort(o), O.test(e) && o.reverse()), this.pushStack(o)
        }
    });
    var N = /[^\x20\t\r\n\f]+/g;
                            ...
                            return function () {
                                var s = this, l = arguments, c = function () {
                                    ...
                                    if (!(t < r)) {
                                        ...
                                        c = e && ("object" == typeof e || "function" == typeof e) && e.then, g(c) ? o ? c.call(e, a(r, n, R, o), a(r, n, F, o)) : (r++, c.call(e, a(r, n, R, o), a(r, n, F, o), a(r, n, R, n.notifyWith))) : (i !== R && (s = void 0, l = [e]), (o || n.resolveWith)(s, l))
                                    }
                                }, u = o ? c : function () {
                                    try {
                                        c()
                                    } catch (e) {
                                        x.Deferred.exceptionHook && x.Deferred.exceptionHook(e, u.stackTrace), t + 1 >= r && (i !== F && (s = void 0, l = [e]), n.rejectWith(s, l))
                                    }
                                };
    ...
    }), x.ready.then = W.then, "complete" === i.readyState || "loading" !== i.readyState && !i.documentElement.doScroll ? e.setTimeout(x.ready) : (i.addEventListener("DOMContentLoaded", H), e.addEventListener("load", H));
    var B = function (e, t, n, i, o, r, a) {
        var s = 0, l = e.length, c = null == n;
        if ("object" === b(n)) for (s in o = !0, n) B(e, t, s, n[s], !0, r, a); else if (void 0 !== i && (o = !0, g(i) || (a = !0), c && (a ? (t.call(e, i), t = null) : (c = t, t = function (e, t, n) {
            return c.call(x(e), n)
    ...
    function Y(e) {
        return e.replace(V, "ms-").replace(z, q)
    }
    ...
    var K = new U, Q = new U, G = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/, Z = /[A-Z]/g;
    ...
    x.extend({
        ...
        queue: function (e, t) {
            ...
            for ("string" != typeof e && (t = e, e = void 0), e = e || "fx"; a--;) (n = K.get(r[a], e + "queueHooks")) && n.empty && (i++, n.empty.add(s));
    ...
    function re(e, t, n, i) {
        ...
        if (u && u[3] !== c) {
            for (l /= 2, c = c || u[3], u = +l || 1; a--;) x.style(e, t, u + c), (1 - r) * (1 - (r = s() / l || .5)) <= 0 && (a = 0), u /= r;
    ...
    function le(e, t) {
        for (var n, i, o = [], r = 0, a = e.length; r < a; r++) (i = e[r]).style && (n = i.style.display, t ? ("none" === n && (o[r] = K.get(i, "display") || null, o[r] || (i.style.display = "")), "" === i.style.display && ie(i) && (o[r] = se(i))) : "none" !== n && (o[r] = "none", K.set(i, "display", n)));
    ...
    function me(e, t, n, i, o) {
        for (var r, a, s, l, c, u, d = t.createDocumentFragment(), h = [], f = 0, p = e.length; f < p; f++) if ((r = e[f]) || 0 === r) if ("object" === b(r)) x.merge(h, r.nodeType ? [r] : r); else if (ge.test(r)) {
            for (a = a || d.appendChild(t.createElement("div")), s = (ue.exec(r) || ["", ""])[1].toLowerCase(), l = he[s] || he._default, a.innerHTML = l[1] + x.htmlPrefilter(r) + l[2], u = l[0]; u--;) a = a.lastChild;
            x.merge(h, a.childNodes), (a = d.firstChild).textContent = ""
        } else h.push(t.createTextNode(r));
        for (d.textContent = "", f = 0; r = h[f++];) if (i && x.inArray(r, i) > -1) o && o.push(r); else if (c = x.contains(r.ownerDocument, r), a = fe(d.appendChild(r), "script"), c && pe(a), n) for (u = 0; r = a[u++];) de.test(r.type || "") && n.push(r);
        return d
    }
    ...
    x.event = {
        global: {}, add: function (e, t, n, i, o) {
            ...
            if (m) for (n.handler && (n = (r = n).handler, o = r.selector), o && x.find.matchesSelector(ve, o), n.guid || (n.guid = x.guid++), (l = m.events) || (l = m.events = {}), (a = m.handle) || (a = m.handle = function (t) {
            ...
            }), c = (t = (t || "").match(N) || [""]).length; c--;) f = g = (s = xe.exec(t[c]) || [])[1], p = (s[2] || "").split(".").sort(), f && (d = x.event.special[f] || {}, f = (o ? d.delegateType : d.bindType) || f, d = x.event.special[f] || {}, u = x.extend({
                type: f,
                origType: g,
                data: i,
                handler: n,
                ...
                namespace: p.join(".")
            }, r), (h = l[f]) || ((h = l[f] = []).delegateCount = 0, d.setup && !1 !== d.setup.call(e, i, p, a) || e.addEventListener && e.addEventListener(f, a)), d.add && (d.add.call(e, u), u.handler.guid || (u.handler.guid = n.guid)), o ? h.splice(h.delegateCount++, 0, u) : h.push(u), x.event.global[f] = !0)
        }, remove: function (e, t, n, i, o) {
            var r, a, s, l, c, u, d, h, f, p, g, m = K.hasData(e) && K.get(e);
            if (m && (l = m.events)) {
                for (c = (t = (t || "").match(N) || [""]).length; c--;) if (f = g = (s = xe.exec(t[c]) || [])[1], p = (s[2] || "").split(".").sort(), f) {
                    for (d = x.event.special[f] || {}, h = l[f = (i ? d.delegateType : d.bindType) || f] || [], s = s[2] && new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)"), a = r = h.length; r--;) u = h[r], !o && g !== u.origType || n && n.guid !== u.guid || s && !s.test(u.namespace) || i && i !== u.selector && ("**" !== i || !u.selector) || (h.splice(r, 1), u.selector && h.delegateCount--, d.remove && d.remove.call(e, u));
            ...
            var t, n, i, o, r, a, s = x.event.fix(e), l = new Array(arguments.length),
                c = (K.get(this, "events") || {})[s.type] || [], u = x.event.special[s.type] || {};
            ...
            if (l && c.nodeType && !("click" === e.type && e.button >= 1)) for (; c !== this; c = c.parentNode || this) if (1 === c.nodeType && ("click" !== e.type || !0 !== c.disabled)) {
                for (r = [], a = {}, n = 0; n < l; n++) void 0 === a[o = (i = t[n]).selector + " "] && (a[o] = i.needsContext ? x(o, this).index(c) > -1 : x.find(o, this, null, [c]).length), a[o] && r.push(i);
    ...
    var Se = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([a-z][^\/\0>\x20\t\r\n\f]*)[^>]*)\/>/gi,
        Te = /<script|<style|<link/i, Ee = /checked\s*(?:[^=]|=\s*.checked.)/i,
        Ae = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;
    ...
    function Oe(e, t) {
        var n, i, o, r, a, s, l, c;
        if (1 === t.nodeType) {
            if (K.hasData(e) && (r = K.access(e), a = K.set(t, r), c = r.events)) for (o in delete a.handle, a.events = {}, c) for (n = 0, i = c[o].length; n < i; n++) x.event.add(t, o, c[o][n]);
            Q.hasData(e) && (s = Q.access(e), l = x.extend({}, s), Q.set(t, l))
        }
    }
    ...
    function Le(e, t, n, i) {
        ...
        if (h && (r = (o = me(t, e[0].ownerDocument, !1, e, i)).firstChild, 1 === o.childNodes.length && (o = r), r || i)) {
            for (l = (s = x.map(fe(o, "script"), De)).length; d < h; d++) c = o, d !== f && (c = x.clone(c, !0, !0), l && x.merge(s, fe(c, "script"))), n.call(e[d], c, d);
            if (l) for (u = s[s.length - 1].ownerDocument, x.map(s, Ie), d = 0; d < l; d++) c = s[d], de.test(c.type || "") && !K.access(c, "globalEval") && x.contains(u, c) && (c.src && "module" !== (c.type || "").toLowerCase() ? x._evalUrl && x._evalUrl(c.src) : y(c.textContent.replace(Ae, ""), u, c))
        }
        return e
    }
    ...
    x.extend({
        htmlPrefilter: function (e) {
            ...
            if (!(p.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || x.isXMLDoc(e))) for (a = fe(s), i = 0, o = (r = fe(e)).length; i < o; i++) Me(r[i], a[i]);
            if (t) if (n) for (r = r || fe(e), a = a || fe(s), i = 0, o = r.length; i < o; i++) Oe(r[i], a[i]); else Oe(e, s);
    ...
    !function () {
        function t() {
            if (u) {
                ...
                o = "1%" !== t.top, l = 12 === n(t.marginLeft), u.style.right = "60%", s = 36 === n(t.right), r = 36 === n(t.width), u.style.position = "absolute", a = 36 === u.offsetWidth || "absolute", ve.removeChild(c), u = null
            }
        }
    ...
    var He = /^(none|table(?!-c[ea]).+)/, Be = /^--/,
        ...
        ze = {letterSpacing: "0", fontWeight: "400"}, qe = ["Webkit", "Moz", "ms"], Ye = i.createElement("div").style;
    ...
    function Qe(e, t, n) {
        var i = Fe(e), o = $e(e, t, i), r = "border-box" === x.css(e, "boxSizing", !1, i), a = r;
        if (Re.test(o)) {
            if (!n) return o;
            o = "auto"
        }
        return a = a && (p.boxSizingReliable() || o === e.style[t]), ("auto" === o || !parseFloat(o) && "inline" === x.css(e, "display", !1, i)) && (o = e["offset" + t[0].toUpperCase() + t.slice(1)], a = !0), (o = parseFloat(o) || 0) + Ke(e, t, n || (r ? "border" : "content"), a, i, o) + "px"
    }
    ...
    x.extend({
        ...
        style: function (e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var o, r, a, s = Y(t), l = Be.test(t), c = e.style;
                if (l || (t = Xe(s)), a = x.cssHooks[t] || x.cssHooks[s], void 0 === n) return a && "get" in a && void 0 !== (o = a.get(e, !1, i)) ? o : c[t];
                "string" == (r = typeof n) && (o = te.exec(n)) && o[1] && (n = re(e, t, o), r = "number"), null != n && n == n && ("number" === r && (n += o && o[3] || (x.cssNumber[s] ? "" : "px")), p.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (c[t] = "inherit"), a && "set" in a && void 0 === (n = a.set(e, n, i)) || (l ? c.setProperty(t, n) : c[t] = n))
            }
        },
        css: function (e, t, n, i) {
            var o, r, a, s = Y(t);
            return Be.test(t) || (t = Xe(s)), (a = x.cssHooks[t] || x.cssHooks[s]) && "get" in a && (o = a.get(e, !0, n)), void 0 === o && (o = $e(e, t, i)), "normal" === o && t in ze && (o = ze[t]), "" === n || n ? (r = parseFloat(o), !0 === n || isFinite(r) ? r || 0 : o) : o
        }
    }), x.each(["height", "width"], function (e, t) {
        x.cssHooks[t] = {
            get: function (e, n, i) {
                if (n) return !He.test(x.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? Qe(e, t, i) : oe(e, Ve, function () {
                    return Qe(e, t, i)
                })
            }, set: function (e, n, i) {
                var o, r = Fe(e), a = "border-box" === x.css(e, "boxSizing", !1, r), s = i && Ke(e, t, i, a, r);
                return a && p.scrollboxSize() === r.position && (s -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(r[t]) - Ke(e, t, "border", !1, r) - .5)), s && (o = te.exec(n)) && "px" !== (o[3] || "px") && (e.style[t] = n, n = x.css(e, t)), Ue(0, n, s)
            }
        }
    ...
    }), x.Tween = Ge, Ge.prototype = {
        constructor: Ge, init: function (e, t, n, i, o, r) {
    ...
    function at(e, t, n) {
        var i, o, r = 0, a = at.prefilters.length, s = x.Deferred().always(function () {
            ...
            if (o) return !1;
            for (var t = Ze || it(), n = Math.max(0, c.startTime + c.duration - t), i = 1 - (n / c.duration || 0), r = 0, a = c.tweens.length; r < a; r++) c.tweens[r].run(i);
        ...
        }(u, c.opts.specialEasing); r < a; r++) if (i = at.prefilters[r].call(c, e, u, c.opts)) return g(i.stop) && (x._queueHooks(c.elem, c.opts.queue).stop = i.stop.bind(i)), i;
        return x.map(u, rt, c), g(c.opts.start) && c.opts.start.call(e, c), c.progress(c.opts.progress).done(c.opts.done, c.opts.complete).fail(c.opts.fail).always(c.opts.always), x.fx.timer(x.extend(l, {
            elem: e,
            anim: c,
            queue: c.opts.queue
        })), c
    ...
    x.Animation = x.extend(at, {
        tweeners: {
            ...
            if ((l = !x.isEmptyObject(t)) || !x.isEmptyObject(f)) for (i in d && 1 === e.nodeType && (n.overflow = [p.overflow, p.overflowX, p.overflowY], null == (c = m && m.display) && (c = K.get(e, "display")), "none" === (u = x.css(e, "display")) && (c ? u = c : (le([e], !0), c = e.style.display || c, u = x.css(e, "display"), le([e]))), ("inline" === u || "inline-block" === u && null != c) && "none" === x.css(e, "float") && (l || (h.done(function () {
                p.display = c
            }), null == c && (u = p.display, c = "none" === u ? "" : u)), p.display = "inline-block")), n.overflow && (p.overflow = "hidden", h.always(function () {
                p.overflow = n.overflow[0], p.overflowX = n.overflow[1], p.overflowY = n.overflow[2]
            })), l = !1, f) l || (m ? "hidden" in m && (g = m.hidden) : m = K.access(e, "fxshow", {display: c}), r && (m.hidden = !g), g && le([e], !0), h.done(function () {
                for (i in g || le([e]), K.remove(e, "fxshow"), f) x.style(e, i, f[i])
        ...
        fadeTo: function (e, t, n, i) {
            ...
            return "string" != typeof e && (n = t, t = e, e = void 0), t && !1 !== e && this.queue(e || "fx", []), this.each(function () {
                var t = !0, o = null != e && e + "queueHooks", r = x.timers, a = K.get(this);
            ...
            return !1 !== e && (e = e || "fx"), this.each(function () {
                var t, n = K.get(this), i = n[e + "queue"], o = n[e + "queueHooks"], r = x.timers, a = i ? i.length : 0;
    ...
    x.fn.extend({
        ...
        addClass: function (e) {
            ...
            return "boolean" == typeof t && i ? t ? this.addClass(e) : this.removeClass(e) : g(e) ? this.each(function (n) {
                ...
                var t, o, r, a;
                if (i) for (o = 0, r = x(this), a = ft(e); t = a[o++];) r.hasClass(t) ? r.removeClass(t) : r.addClass(t); else void 0 !== e && "boolean" !== n || ((t = ht(this)) && K.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || !1 === e ? "" : K.get(this, "__className__") || ""))
            })
        }, hasClass: function (e) {
            var t, n, i = 0;
    ...
    x.extend(x.event, {
        trigger: function (t, n, o, r) {
            ...
            if (s = p = l = o = o || i, 3 !== o.nodeType && 8 !== o.nodeType && !gt.test(y + x.event.triggered) && (y.indexOf(".") > -1 && (y = (b = y.split(".")).shift(), b.sort()), u = y.indexOf(":") < 0 && "on" + y, (t = t[x.expando] ? t : new x.Event(y, "object" == typeof t && t)).isTrigger = r ? 2 : 3, t.namespace = b.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + b.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = o), n = null == n ? [t] : x.makeArray(n, [t]), f = x.event.special[y] || {}, r || !f.trigger || !1 !== f.trigger.apply(o, n))) {
                if (!r && !f.noBubble && !m(o)) {
                    for (c = f.delegateType || y, gt.test(c + y) || (s = s.parentNode); s; s = s.parentNode) v.push(s), l = s;
                    l === (o.ownerDocument || i) && v.push(l.defaultView || l.parentWindow || e)
                }
                for (a = 0; (s = v[a++]) && !t.isPropagationStopped();) p = s, t.type = a > 1 ? c : f.bindType || y, (h = (K.get(s, "events") || {})[t.type] && K.get(s, "handle")) && h.apply(s, n), (h = u && s[u]) && h.apply && X(s) && (t.result = h.apply(s, n), !1 === t.result && t.preventDefault());
                return t.type = y, r || t.isDefaultPrevented() || f._default && !1 !== f._default.apply(v.pop(), n) || !X(o) || u && g(o[y]) && !m(o) && ((l = o[u]) && (o[u] = null), x.event.triggered = y, t.isPropagationStopped() && p.addEventListener(y, mt), o[y](), t.isPropagationStopped() && p.removeEventListener(y, mt), x.event.triggered = void 0, l && (o[u] = l)), t.result
            }
    ...
    x.param = function (e, t) {
        ...
        serialize: function () {
            ...
            return this.map(function () {
                ...
                var e = this.type;
                return this.name && !x(this).is(":disabled") && Ct.test(this.nodeName) && !kt.test(e) && (this.checked || !ce.test(e))
            }).map(function (e, t) {
                var n = x(this).val();
    ...
    var St = /%20/g, Tt = /#.*$/, Et = /([?&])_=[^&]*/, At = /^(.*?):[ \t]*([^\r\n]*)$/gm, Pt = /^(?:GET|HEAD)$/,
        Dt = /^\/\//, It = {}, Ot = {}, Mt = "*/".concat("*"), Lt = i.createElement("a");
    ...
    Lt.href = vt.href, x.extend({
        ...
        ajax: function (t, n) {
            ...
            var o, r, a, s, l, c, u, d, h, f, p = x.ajaxSetup({}, n), g = p.context || p,
                ...
                y = x.Callbacks("once memory"), b = p.statusCode || {}, w = {}, k = {}, C = "canceled", _ = {
                    readyState: 0, getResponseHeader: function (e) {
                        ...
                        var t;
                        if (e) if (u) _.always(e[_.status]); else for (t in e) b[t] = [b[t], e[t]];
                        return this
                    }, abort: function (e) {
                        var t = e || C;
            ...
            if (v.promise(_), p.url = ((t || p.url || vt.href) + "").replace(Dt, vt.protocol + "//"), p.type = n.method || n.type || p.method || p.type, p.dataTypes = (p.dataType || "*").toLowerCase().match(N) || [""], null == p.crossDomain) {
                c = i.createElement("a");
                try {
            ...
            function S(t, n, i, s) {
                var c, h, f, w, k, C = n;
                u || (u = !0, l && e.clearTimeout(l), o = void 0, a = s || "", _.readyState = t > 0 ? 4 : 0, c = t >= 200 && t < 300 || 304 === t, i && (w = function (e, t, n) {
    ...
    var jt = {0: 200, 1223: 204}, $t = x.ajaxSettings.xhr();
    ...
    x.ajaxSetup({
        ...
        if (s || "jsonp" === t.dataTypes[0]) return o = t.jsonpCallback = g(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(Ht, "$1" + o) : !1 !== t.jsonp && (t.url += (bt.test(t.url) ? "&" : "?") + t.jsonp + "=" + o), t.converters["script json"] = function () {
        ...
        setOffset: function (e, t, n) {
            var i, o, r, a, s, l, c = x.css(e, "position"), u = x(e), d = {};
            "static" === c && (e.style.position = "relative"), s = u.offset(), r = x.css(e, "top"), l = x.css(e, "left"), ("absolute" === c || "fixed" === c) && (r + l).indexOf("auto") > -1 ? (a = (i = u.position()).top, o = i.left) : (a = parseFloat(r) || 0, o = parseFloat(l) || 0), g(t) && (t = t.call(e, n, x.extend({}, s))), null != t.top && (d.top = t.top - s.top + a), null != t.left && (d.left = t.left - s.left + o), "using" in t ? t.using.call(e, d) : u.css(d)
        }
    }, x.fn.extend({
        offset: function (e) {
        ...
        x.cssHooks[t] = We(p.pixelPosition, function (e, n) {
            if (n) return n = $e(e, t), Re.test(n) ? x(e).position()[t] + "px" : n
        })
    ...
    return x.noConflict = function (t) {
        return e.$ === x && (e.$ = Vt), t && e.jQuery === x && (e.jQuery = Bt), x
    }, t || (e.jQuery = e.$ = x), x
}), function (e, t) {
    ...
    function d(e, t, n, i) {
        return W(t["offset" + e], t["scroll" + e], n["client" + e], n["offset" + e], n["scroll" + e], o(10) ? parseInt(n["offset" + e]) + parseInt(i["margin" + ("Height" === e ? "Top" : "Left")]) + parseInt(i["margin" + ("Height" === e ? "Bottom" : "Right")]) : 0)
    }
    ...
    function g(e, n) {
        ...
        r && s && (u.top = W(u.top, 0), u.left = W(u.left, 0));
    ...
    function m(e) {
        var t = 1 < arguments.length && void 0 !== arguments[1] && arguments[1], n = e.ownerDocument.documentElement,
            i = g(e, n), o = W(n.clientWidth, window.innerWidth || 0), r = W(n.clientHeight, window.innerHeight || 0),
    ...
    function D(e, t, n, o) {
        n.updateBound = o, P(e).addEventListener("resize", n.updateBound, {passive: !0});
        var r = i(e);
    ...
    function M(e, t) {
        Object.keys(t).forEach(function (n) {
            var i = "";
            -1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(n) && O(t[n]) && (i = "px"), e.style[n] = t[n] + i
        })
    }
        ...
        return (c = c.map(function (e, i) {
            ...
            return e.reduce(function (e, t) {
                ...
                return function (e, t, n, i) {
                    ...
                    return "vh" === a || "vw" === a ? ("vh" === a ? W(document.documentElement.clientHeight, window.innerHeight || 0) : W(document.documentElement.clientWidth, window.innerWidth || 0)) / 100 * r : r
                }(e, o, t, n)
            })
    ...
    for (var F = Math.min, j = Math.round, $ = Math.floor, W = Math.max, H = "undefined" != typeof window && "undefined" != typeof document, B = ["Edge", "Trident", "Firefox"], V = 0, z = 0; z < B.length; z += 1) if (H && 0 <= navigator.userAgent.indexOf(B[z])) {
        V = 1;
        break
    }
    var q = H && window.Promise ? function (e) {
            var t = !1;
            return function () {
        ...
        }, Y = H && !(!window.MSInputMethodContext || !document.documentMode), X = H && /MSIE 10/.test(navigator.userAgent),
        U = function (e, t) {
                ...
                key: "update", value: function () {
                    return function () {
                        if (!this.state.isDestroyed) {
                            ...
                            e.offsets.reference = w(this.state, this.popper, this.reference, this.options.positionFixed), e.placement = x(this.options.placement, e.offsets.reference, this.popper, this.reference, this.options.modifiers.flip.boundariesElement, this.options.modifiers.flip.padding), e.originalPlacement = e.placement, e.positionFixed = this.options.positionFixed, e.offsets.popper = _(this.popper, e.offsets.reference, e.placement), e.offsets.popper.position = this.options.positionFixed ? "fixed" : "absolute", e = T(this.modifiers, e), this.state.isCreated ? this.options.onUpdate(e) : (this.state.isCreated = !0, this.options.onCreate(e))
                        }
                    }.call(this)
                }
            }, {
            ...
            shift: {
                ...
                order: 200, enabled: !0, fn: function (e, t) {
                    var n, i = t.offset, o = e.placement, r = e.offsets, a = r.popper, s = r.reference,
                        l = o.split("-")[0];
                    return n = O(+i) ? [+i, 0] : R(i, a, s, l), "left" === l ? (a.top += n[0], a.left -= n[1]) : "right" === l ? (a.top += n[0], a.left += n[1]) : "top" === l ? (a.left += n[0], a.top -= n[1]) : "bottom" === l && (a.left += n[0], a.top += n[1]), e.popper = a, e
                }, offset: 0
            }, preventOverflow: {
                order: 300, enabled: !0, fn: function (e, t) {
                    ...
                    var u = t.priority, d = e.offsets.popper, h = {
                        primary: function (e) {
                            var n = d[e];
                            return d[e] < c[e] && !t.escapeWithReference && (n = W(d[e], c[e])), Q({}, e, n)
                        }, secondary: function (e) {
                            var n = "right" === e ? "left" : "top", i = d[n];
                            return d[e] > c[e] && !t.escapeWithReference && (i = F(d[n], c[e] - ("right" === e ? d.width : d.height))), Q({}, n, i)
                        }
                    };
                ...
                order: 500, enabled: !0, fn: function (e, n) {
                    ...
                    return w = W(F(s[u] - m, w), 0), e.arrowElement = o, e.offsets.arrow = (Q(i = {}, h, j(w)), Q(i, p, ""), i), e
                }, element: "[x-arrow]"
            }, flip: {
                order: 600, enabled: !0, fn: function (e, t) {
                    ...
                    return a.forEach(function (s, l) {
                        ...
                        }(r)), e.placement = i + (r ? "-" + r : ""), e.offsets.popper = G({}, e.offsets.popper, _(e.instance.popper, e.offsets.reference, e.placement)), e = T(e.instance.modifiers, e, "flip"))
                    }), e
                ...
                order: 850, enabled: !0, fn: function (e, t) {
                    var n = t.x, i = t.y, o = e.offsets.popper, a = S(e.instance.modifiers, function (e) {
                ...
                order: 900, enabled: !0, fn: function (e) {
                    return M(e.instance.popper, e.styles), function (e, t) {
                        Object.keys(t).forEach(function (n) {
                    ...
                    return t.setAttribute("x-placement", a), M(t, {position: n.positionFixed ? "fixed" : "absolute"}), n
    ...
    var m = t.fn.button, v = "active", y = "btn", b = "focus", x = '[data-toggle^="button"]',
        w = '[data-toggle="buttons"]', k = 'input:not([type="hidden"])', C = ".active", _ = ".btn", S = {
    ...
    t(document).on(S.CLICK_DATA_API, x, function (e) {
        e.preventDefault();
        var n = e.target;
        t(n).hasClass(y) || (n = t(n).closest(_)), T._jQueryInterface.call(t(n), "toggle")
    ...
    var E = "carousel", A = ".bs.carousel", P = t.fn[E],
        D = {interval: 5e3, keyboard: !0, slide: !1, pause: "hover", wrap: !0, touch: !0}, I = {
            ...
            wrap: "boolean",
            touch: "boolean"
        }, O = "next", M = "prev", L = "left", N = "right", R = {
        ...
        }, F = "carousel", j = "active", $ = "slide", W = "carousel-item-right", H = "carousel-item-left",
        B = "carousel-item-next", V = "carousel-item-prev", z = "pointer-event", q = {
        ...
        }, Y = {TOUCH: "touch", PEN: "pen"}, X = function () {
            function e(e, t) {
            ...
            return n.next = function () {
                ...
                if (!(e > this._items.length - 1 || e < 0)) if (this._isSliding) t(this._element).one(R.SLID, function () {
                    return n.to(e)
                }); else {
                ...
                return e = a({}, D, e), c.typeCheckConfig(E, e, I), e
                ...
                if (this._touchSupported) {
                    ...
                    t(this._element.querySelectorAll(q.ITEM_IMG)).on(R.DRAG_START, function (e) {
                        return e.preventDefault()
                    }), this._pointerEvent ? (t(this._element).on(R.POINTERDOWN, function (e) {
                        return n(e)
                    }), t(this._element).on(R.POINTERUP, function (e) {
                        return i(e)
                    }), this._element.classList.add(z)) : (t(this._element).on(R.TOUCHSTART, function (e) {
                        return n(e)
                ...
                var n = e === O, i = e === M, o = this._getItemIndex(t), r = this._items.length - 1;
                if ((i && 0 === o || n && o === r) && !this._config.wrap) return t;
                var a = (o + (e === M ? -1 : 1)) % this._items.length;
                return -1 === a ? this._items[this._items.length - 1] : this._items[a]
            }, n._triggerSlideEvent = function (e, n) {
                var i = this._getItemIndex(e), o = this._getItemIndex(this._element.querySelector(q.ACTIVE_ITEM)),
                    r = t.Event(R.SLIDE, {relatedTarget: e, direction: n, from: o, to: i});
                ...
                if (e === O ? (i = H, o = B, r = L) : (i = W, o = V, r = N), u && t(u).hasClass(j)) this._isSliding = !1; else if (!this._triggerSlideEvent(u, r).isDefaultPrevented() && s && u) {
                    this._isSliding = !0, h && this.pause(), this._setActiveIndicatorElement(u);
                    var f = t.Event(R.SLID, {relatedTarget: u, direction: r, from: l, to: d});
                ...
                return this.each(function () {
                    var i = t(this).data("bs.carousel"), o = a({}, D, t(this).data());
    ...
    t(document).on(R.CLICK_DATA_API, q.DATA_SLIDE, X._dataApiClickHandler), t(window).on(R.LOAD_DATA_API, function () {
        ...
        return t.fn[E] = P, X._jQueryInterface
    };
    var U = "collapse", K = t.fn[U], Q = {toggle: !0, parent: ""}, G = {toggle: "boolean", parent: "(string|element)"},
        Z = {
        ...
        re = {ACTIVES: ".show, .collapsing", DATA_TOGGLE: '[data-toggle="collapse"]'}, ae = function () {
            ...
            return n.toggle = function () {
                ...
                return (e = a({}, Q, e)).toggle = Boolean(e.toggle), c.typeCheckConfig(U, e, G), e
    ...
    }), t.fn[U] = ae._jQueryInterface, t.fn[U].Constructor = ae, t.fn[U].noConflict = function () {
        return t.fn[U] = K, ae._jQueryInterface
    };
    var se = "dropdown", le = t.fn[se], ce = new RegExp("38|40|27"), ue = {
        ...
        _e = "top-end", Se = "bottom-start", Te = "bottom-end", Ee = "right-start", Ae = "left-start",
        Pe = {offset: 0, flip: !0, boundary: "scrollParent", reference: "toggle", display: "dynamic"}, De = {
            ...
            return i.toggle = function () {
                ...
                return e.hasClass(fe) ? (n = Ce, t(this._menu).hasClass(me) && (n = _e)) : e.hasClass(pe) ? n = Ee : e.hasClass(ge) ? n = Ae : t(this._menu).hasClass(me) && (n = Te), n
    ...
    t(document).on(ue.KEYDOWN_DATA_API, ye, Ie._dataApiKeydownHandler).on(ue.KEYDOWN_DATA_API, xe, Ie._dataApiKeydownHandler).on(ue.CLICK_DATA_API + " " + ue.KEYUP_DATA_API, Ie._clearMenus).on(ue.CLICK_DATA_API, ye, function (e) {
        e.preventDefault(), e.stopPropagation(), Ie._jQueryInterface.call(t(this), "toggle")
    }).on(ue.CLICK_DATA_API, be, function (e) {
        e.stopPropagation()
    }), t.fn[se] = Ie._jQueryInterface, t.fn[se].Constructor = Ie, t.fn[se].noConflict = function () {
        return t.fn[se] = le, Ie._jQueryInterface
    };
    var Oe = t.fn.modal, Me = {backdrop: !0, keyboard: !0, focus: !0, show: !0},
        ...
        }, Re = "modal-dialog-scrollable", Fe = "modal-scrollbar-measure", je = "modal-backdrop", $e = "modal-open",
        We = "fade", He = "show", Be = {
            DIALOG: ".modal-dialog",
            ...
            return n.toggle = function (e) {
                ...
                if (e && e.preventDefault(), this._isShown && !this._isTransitioning) {
                    ...
                    if (t(this._element).trigger(i), this._isShown && !i.isDefaultPrevented()) {
                        ...
                        if (o && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), t(document).off(Ne.FOCUSIN), t(this._element).removeClass(He), t(this._element).off(Ne.CLICK_DISMISS), t(this._dialog).off(Ne.MOUSEDOWN_DISMISS), o) {
                ...
                return e = a({}, Me, e), c.typeCheckConfig("modal", e, Le), e
            }, n._showElement = function (e) {
                var n = this, i = t(this._element).hasClass(We);
                this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), this._element.style.display = "block", this._element.removeAttribute("aria-hidden"), this._element.setAttribute("aria-modal", !0), t(this._dialog).hasClass(Re) ? this._dialog.querySelector(Be.MODAL_BODY).scrollTop = 0 : this._element.scrollTop = 0, i && c.reflow(this._element), t(this._element).addClass(He), this._config.focus && this._enforceFocus();
                ...
                var n = this, i = t(this._element).hasClass(We) ? We : "";
                if (this._isShown && this._config.backdrop) {
                    ...
                    }), i && c.reflow(this._backdrop), t(this._backdrop).addClass(He), !e) return;
                    if (!i) return void e();
                ...
                return this.each(function () {
                    var o = t(this).data("bs.modal"), r = a({}, Me, t(this).data(), "object" == typeof n && n ? n : {});
    ...
    t(document).on(Ne.CLICK_DATA_API, Be.DATA_TOGGLE, function (e) {
        ...
        return t.fn.modal = Oe, Ve._jQueryInterface
    };
        ...
        for (var i = (new window.DOMParser).parseFromString(e, "text/html"), o = Object.keys(t), r = [].slice.call(i.body.querySelectorAll("*")), a = function (e, n) {
            ...
            s.forEach(function (e) {
                (function (e, t) {
                    ...
                    if (-1 !== t.indexOf(n)) return -1 === ze.indexOf(n) || Boolean(e.nodeValue.match(Ye) || e.nodeValue.match(Xe));
    ...
    var Ke = "tooltip", Qe = t.fn.tooltip, Ge = new RegExp("(^|\\s)bs-tooltip\\S+", "g"),
        ...
        ht = "manual", ft = function () {
            ...
            return i.enable = function () {
                ...
                "object" != typeof n || !n.nodeType && !n.jquery ? this.config.html ? (this.config.sanitize && (n = Ue(n, this.config.whiteList, this.config.sanitizeFn)), e.html(n)) : e.text(n) : this.config.html ? t(n).parent().is(e) || e.empty().append(n) : e.text(t(n).text())
            }, i.getTitle = function () {
                ...
                return Object.keys(n).forEach(function (e) {
                    ...
                    show: e.delay,
                    hide: e.delay
                }), "number" == typeof e.title && (e.title = e.title.toString()), "number" == typeof e.content && (e.content = e.content.toString()), c.typeCheckConfig(Ke, e, this.constructor.DefaultType), e.sanitize && (e.template = Ue(e.template, e.whiteList, e.sanitizeFn)), e
    ...
    t.fn.popover = _t._jQueryInterface, t.fn.popover.Constructor = _t, t.fn.popover.noConflict = function () {
        return t.fn.popover = gt, _t._jQueryInterface
    };
    var St = "scrollspy", Tt = t.fn[St], Et = {offset: 10, method: "auto", target: ""},
        At = {offset: "number", method: "string", target: "(string|element)"}, Pt = {
            ACTIVATE: "activate.bs.scrollspy",
            SCROLL: "scroll.bs.scrollspy",
            LOAD_DATA_API: "load.bs.scrollspy.data-api"
        }, Dt = "dropdown-item", It = "active", Ot = {
            ...
            return n.refresh = function () {
                var e = this, n = this._scrollElement === this._scrollElement.window ? Mt : Lt,
                ...
                if ("string" != typeof(e = a({}, Et, "object" == typeof e && e ? e : {})).target) {
                    ...
                    n || (n = c.getUID(St), t(e.target).attr("id", n)), e.target = "#" + n
                }
                return c.typeCheckConfig(St, e, At), e
                ...
                i.hasClass(Dt) ? (i.closest(Ot.DROPDOWN).find(Ot.DROPDOWN_TOGGLE).addClass(It), i.addClass(It)) : (i.addClass(It), i.parents(Ot.NAV_LIST_GROUP).prev(Ot.NAV_LINKS + ", " + Ot.LIST_ITEMS).addClass(It), i.parents(Ot.NAV_LIST_GROUP).prev(Ot.NAV_ITEMS).children(Ot.NAV_LINKS).addClass(It)), t(this._scrollElement).trigger(Pt.ACTIVATE, {relatedTarget: e})
            }, n._clear = function () {
    ...
    }), t.fn[St] = Nt._jQueryInterface, t.fn[St].Constructor = Nt, t.fn[St].noConflict = function () {
        return t.fn[St] = Tt, Nt._jQueryInterface
    };
    var Rt = t.fn.tab, Ft = {
            HIDE: "hide.bs.tab",
        ...
        }, jt = "dropdown-menu", $t = "active", Wt = "disabled", Ht = "fade", Bt = "show", Vt = ".dropdown",
        zt = ".nav, .list-group", qt = ".active", Yt = "> li > .active",
        Xt = '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', Ut = ".dropdown-toggle",
        Kt = "> .dropdown-menu .active", Qt = function () {
            ...
            return n.show = function () {
                var e = this;
                if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && t(this._element).hasClass($t) || t(this._element).hasClass(Wt))) {
                    ...
                    var s = t.Event(Ft.HIDE, {relatedTarget: this._element}), l = t.Event(Ft.SHOW, {relatedTarget: i});
                    if (i && t(i).trigger(s), t(this._element).trigger(l), !l.isDefaultPrevented() && !s.isDefaultPrevented()) {
                        ...
                        var u = function () {
                            var n = t.Event(Ft.HIDDEN, {relatedTarget: e._element}),
                                o = t.Event(Ft.SHOWN, {relatedTarget: i});
                ...
                var o = this, r = (!n || "UL" !== n.nodeName && "OL" !== n.nodeName ? t(n).children(qt) : t(n).find(Yt))[0],
                    a = i && r && t(r).hasClass(Ht), s = function () {
                ...
                if (t(e).addClass($t), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !0), c.reflow(e), e.classList.contains(Ht) && e.classList.add(Bt), e.parentNode && t(e.parentNode).hasClass(jt)) {
                    var r = t(e).closest(Vt)[0];
                    if (r) {
                        var a = [].slice.call(r.querySelectorAll(Ut));
                        t(a).addClass($t)
                    }
    ...
    t(document).on(Ft.CLICK_DATA_API, Xt, function (e) {
        ...
        return t.fn.tab = Rt, Qt._jQueryInterface
    };
    ...
    }(), e.Util = c, e.Alert = g, e.Button = T, e.Carousel = X, e.Collapse = ae, e.Dropdown = Ie, e.Modal = Ve, e.Popover = _t, e.Scrollspy = Nt, e.Tab = Qt, e.Toast = sn, e.Tooltip = ft, Object.defineProperty(e, "__esModule", {value: !0})
                ...
                for (var o = 0; n > o; o++) if (v.State.calls[o]) {
                    ...
                    for (var m = Math.min((t - h) / d.duration, 1), y = 0, x = s.length; x > y; y++) {
                        ...
                        if (r(C)) {
                            ...
                            for (var S in d.visibility !== i && "hidden" !== d.visibility && b.setPropertyValue(C, "visibility", d.visibility), k) if ("element" !== S) {
                                var T, E = k[S], A = f.isString(E.easing) ? v.Easings[E.easing] : E.easing;
                                if (1 === m) T = E.endValue; else {
                                    var P = E.endValue - E.startValue;
                                    if (T = E.startValue + P * A(m, d, P), !p && T === E.currentValue) continue
                                }
                                if (E.currentValue = T, "tween" === S) g = T; else {
                                    if (b.Hooks.registered[S]) {
                                        var D = b.Hooks.getRoot(S), I = r(C).rootPropertyValueCache[D];
                                        I && (E.rootPropertyValue = I)
                                    }
                                    var O = b.setPropertyValue(C, S, E.currentValue + (0 === parseFloat(T) ? "" : E.unitType), E.rootPropertyValue, E.scrollData);
                                    b.Hooks.registered[S] && (r(C).rootPropertyValueCache[D] = b.Normalizations.registered[D] ? b.Normalizations.registered[D]("extract", null, O[1]) : O[1]), "transform" === O[0] && (_ = !0)
                                }
                            }
            ...
            var x = function () {
                ...
                function a() {
                    function e(e) {
                        function h(e, t) {
                            var n = i, o = i, r = i;
                            return f.isArray(e) ? (n = e[0], !f.isArray(e[1]) && /^[\d-]/.test(e[1]) || f.isFunction(e[1]) || b.RegEx.isHex.test(e[1]) ? r = e[1] : (f.isString(e[1]) && !b.RegEx.isHex.test(e[1]) || f.isArray(e[1])) && (o = t ? e[1] : s(e[1], c.duration), e[2] !== i && (r = e[2]))) : n = e, t || (o = o || c.easing), f.isFunction(n) && (n = n.call(a, _, C)), f.isFunction(r) && (r = r.call(a, _, C)), [n || 0, o, r]
                        }
                        ...
                        if ("scroll" === T) {
                            var x, k, S, A = /^x$/i.test(c.axis) ? "Left" : "Top", P = parseFloat(c.offset) || 0;
                            c.container ? f.isWrapped(c.container) || f.isNode(c.container) ? (c.container = c.container[0] || c.container, S = (x = c.container["scroll" + A]) + u(a).position()[A.toLowerCase()] + P) : c.container = null : (x = v.State.scrollAnchor[v.State["scrollProperty" + A]], k = v.State.scrollAnchor[v.State["scrollProperty" + ("Left" === A ? "Top" : "Left")]], S = u(a).offset()[A.toLowerCase()] + P), d = {
                                scroll: {
                                    rootPropertyValue: !1,
                                    startValue: x,
                                    currentValue: x,
                            ...
                            for (var I in D) if ("element" !== I) {
                                var O = D[I].startValue;
                                D[I].startValue = D[I].currentValue = D[I].endValue, D[I].endValue = O, f.isEmptyObject(w) || (D[I].easing = c.easing), v.debug && console.log("reverse tweensContainer (" + I + "): " + JSON.stringify(D[I]), a)
                            }
                            d = D
                        } else if ("start" === T) {
                            for (var M in r(a).tweensContainer && !0 === r(a).isAnimating && (D = r(a).tweensContainer), u.each(y, function (e, t) {
                                ...
                                var R = h(y[M]), F = R[0], j = R[1], $ = R[2];
                                M = b.Names.camelCase(M);
                                var W = b.Hooks.getRoot(M), H = !1;
                                if (r(a).isSVG || "tween" === W || !1 !== b.Names.prefixCheck(W)[1] || b.Normalizations.registered[W] !== i) {
                                    (c.display !== i && null !== c.display && "none" !== c.display || c.visibility !== i && "hidden" !== c.visibility) && /opacity|filter/.test(M) && !$ && 0 !== F && ($ = 0), c._cacheValues && D && D[M] ? ($ === i && ($ = D[M].endValue + D[M].unitType), H = r(a).rootPropertyValueCache[W]) : b.Hooks.registered[M] ? $ === i ? (H = b.getPropertyValue(a, W), $ = b.getPropertyValue(a, M, H)) : H = b.Hooks.templates[W][1] : $ === i && ($ = b.getPropertyValue(a, M));
                                    var B, V, z, q = !1;
                                    if ($ = (B = p(M, $))[0], z = B[1], F = (B = p(M, F))[0].replace(/^([+-\/*])=/, function (e, t) {
                                        return q = t, ""
                                    }), V = B[1], $ = parseFloat($) || 0, F = parseFloat(F) || 0, "%" === V && (/^(fontSize|lineHeight)$/.test(M) ? (F /= 100, V = "em") : /^scale/.test(M) ? (F /= 100, V = "") : /(Red|Green|Blue)$/i.test(M) && (F = F / 100 * 255, V = "")), /[\/*]/.test(q)) V = z; else if (z !== V && 0 !== $) if (0 === F) V = z; else {
                                        o = o || g();
                                    ...
                                    d[M] = {
                                        ...
                                        unitType: V,
                                        easing: j
                                    }, v.debug && console.log("tweensContainer (" + M + "): " + JSON.stringify(d[M]), a)
                                } else v.debug && console.log("Skipping [" + W + "] due to a lack of browser support.")
                            }
                            d.element = a
                        }
                        d.element && (b.Values.addClass(a, "velocity-animating"), N.push(d), "" === c.queue && (r(a).tweensContainer = d, r(a).opts = c), r(a).isAnimating = !0, _ === C - 1 ? (v.State.calls.push([N, m, c, null, E.resolver]), !1 === v.State.isTicking && (v.State.isTicking = !0, l())) : _++)
                    }
                ...
                if (f.isWrapped(this) ? (d = !1, p = 0, m = this, h = this) : (d = !0, p = 1, m = k ? arguments[0].elements || arguments[0].e : arguments[0]), m = o(m)) {
                    ...
                    if (!/^(stop|finish)$/i.test(y) && !u.isPlainObject(w)) {
                        w = {};
                        for (var S = p + 1; S < arguments.length; S++) f.isArray(arguments[S]) || !/^(fast|normal|slow)$/i.test(arguments[S]) && !/^\d/.test(arguments[S]) ? f.isString(arguments[S]) || f.isArray(arguments[S]) ? w.easing = arguments[S] : f.isFunction(arguments[S]) && (w.complete = arguments[S]) : w.duration = arguments[S]
                    }
                        ...
                        default:
                            if (!u.isPlainObject(y) || f.isEmptyObject(y)) {
                                if (f.isString(y) && v.Redirects[y]) {
                                    var P = (M = u.extend({}, w)).duration, D = M.delay || 0;
                                    return !0 === M.backwards && (m = u.extend(!0, [], m).reverse()), u.each(m, function (e, t) {
                                        parseFloat(M.stagger) ? M.delay = D + parseFloat(M.stagger) * e : f.isFunction(M.stagger) && (M.delay = D + M.stagger.call(t, e, C)), M.drag && (M.duration = parseFloat(P) || (/^(callout|transition)/.test(y) ? 1e3 : g), M.duration = Math.max(M.duration * (M.backwards ? 1 - e / C : (e + 1) / C), .75 * M.duration, 200)), v.Redirects[y].call(t, t, M || {}, e, C, m, E.promise ? E : i)
                                    }), e()
                                }
                    ...
                    if (u.each(m, function (e, t) {
                        f.isNode(t) && a.call(t)
                    }), (M = u.extend({}, v.defaults, w)).loop = parseInt(M.loop), O = 2 * M.loop - 1, M.loop) for (var R = 0; O > R; R++) {
                        var F = {delay: M.delay, progress: M.progress};
                        R === O - 1 && (F.display = M.display, F.visibility = M.visibility, F.complete = M.complete), x(m, "reverse", F)
                    }
                    return e()
                }
            };
    ...
    return function () {
        ...
        1: [function (e, t, n) {
            ...
            for (var T in _) S[JSON.stringify(_[T])] = T
        }, {}], 5: [function (e, t, n) {
                    ...
                    update: function (e) {
                        ...
                        if (f < 2 * Math.PI) {
                            var p = o.rotation % (2 * Math.PI),
                                ...
                                }, S = {width: .5 * (_.x - C.x), height: .5 * (_.y - C.y)};
                            c = Math.min(s / S.width, l / S.height), u = {x: -.5 * (_.x + C.x), y: -.5 * (_.y + C.y)}
                        }
                ...
                defaults: {}, addBox: function (e, t) {
                    ...
                    if (e) {
                        ...
                        i.each(p.concat(g), function (e) {
                            if (e.getPadding) {
                                var t = e.getPadding();
                                S = Math.max(S, t.left), T = Math.max(T, t.right)
                            }
                        ...
                        i.each(h.concat(f), $), i.each(h, function (e) {
                            ...
                            var t = i.findNextWhere(_, function (t) {
                                return t.box === e
                            }), n = {left: 0, right: 0, top: I, bottom: O};
                            t && e.update(t.minSize.width, C, n)
                        }), P = l, D = c, I = u, O = d, i.each(h, function (e) {
                            P += e.width
                        }), i.each(f, function (e) {
                            D += e.width
                        }), i.each(p, function (e) {
                        ...
                        var M = Math.max(S - P, 0);
                        P += M, D += Math.max(T - D, 0);
                        var L = Math.max(E - I, 0);
                        I += L, O += Math.max(A - O, 0);
                        var N = n - I - O, R = t - P - D;
                    ...
                    function $(e) {
                        ...
                        if (t) if (e.isHorizontal()) {
                            var n = {left: Math.max(P, S), right: Math.max(D, T), top: 0, bottom: 0};
                            e.update(e.fullWidth ? v : k, y / 2, n)
                        } else e.update(t.minSize.width, C)
                    }

                    function W(e) {
                        e.isHorizontal() ? (e.left = e.fullWidth ? l : P, e.right = e.fullWidth ? t - c : P + k, e.top = j, e.bottom = j + e.height, j = e.bottom) : (e.left = F, e.right = F + e.width, e.top = I, e.bottom = I + C, F = e.right)
                    }
                }
            }
                ...
                fit: function () {
                    ...
                    if (o.display && h) {
                        ...
                        if (f) {
                            ...
                            var _ = c(e.ctx, n[0], p.font), S = c(e.ctx, n[n.length - 1], p.font);
                            0 !== e.labelRotation ? (e.paddingLeft = "bottom" === i.position ? k * _ + 3 : k * b + 3, e.paddingRight = "bottom" === i.position ? k * b + 3 : k * S + 3) : (e.paddingLeft = _ / 2 + 3, e.paddingRight = S / 2 + 3)
                ...
                draw: function (e) {
                    ...
                    if (n.display) {
                        var o = t.ctx, a = i.global, s = n.ticks.minor, c = n.ticks.major || s, h = n.gridLines,
                            ...
                            _ = r.options.toPadding(f.padding), S = r.toRadians(t.labelRotation), T = [],
                            E = t.options.gridLines.lineWidth, A = "right" === n.position ? t.left : t.right - E - w,
                            P = "right" === n.position ? t.left + w : t.right,
                            D = "bottom" === n.position ? t.top + E : t.bottom - w - E,
                            I = "bottom" === n.position ? t.top + E + w : t.bottom + E;
                        if (r.each(m, function (i, o) {
                            if (!r.isNullOrUndef(i.label)) {
                                var c, u, d, f, v, y, b, x, k, C, _, O, M, L, N = i.label;
                                ...
                                var R = "middle", F = "middle", j = s.padding;
                                if (g) {
                                    var $ = w + j;
                                    "bottom" === n.position ? (F = p ? "middle" : "top", R = p ? "right" : "center", L = t.top + $) : (F = p ? "middle" : "bottom", R = p ? "left" : "center", L = t.bottom - $);
                                    var W = l(t, o, h.offsetGridLines && m.length > 1);
                                    W < t.left && (u = "rgba(0,0,0,0)"), W += r.aliasPixel(c), M = t.getPixelForTick(o) + s.labelOffset, v = b = k = _ = W, y = D, x = I, C = e.top, O = e.bottom + E
                                } else {
                                    var H, B = "left" === n.position;
                                    s.mirror ? (R = B ? "left" : "right", H = j) : (R = B ? "right" : "left", H = w + j), M = B ? t.right - H : t.left + H;
                                    var V = l(t, o, h.offsetGridLines && m.length > 1);
                                    V < t.top && (u = "rgba(0,0,0,0)"), V += r.aliasPixel(c), L = t.getPixelForTick(o) + s.labelOffset, v = A, b = P, k = e.left, _ = e.right + E, y = x = C = O = V
                                }
                                T.push({
                                    tx1: v,
                                    ty1: y,
                            ...
                            var O, M, L = 0, N = d(f) / 2;
                            if (g) O = t.left + (t.right - t.left) / 2, M = "bottom" === n.position ? t.bottom - N - _.bottom : t.top + N + _.top; else {
                                var R = "left" === n.position;
                                O = R ? t.left + N + _.top : t.right - N - _.top, M = t.top + (t.bottom - t.top) / 2, L = R ? -.5 * Math.PI : .5 * Math.PI
                            }
                            o.save(), o.translate(O, M), o.rotate(L), o.textAlign = "center", o.textBaseline = "middle", o.fillStyle = k, o.font = C.font, o.fillText(f.labelString, 0, 0), o.restore()
                        }
                        if (h.drawBorder) {
                            o.lineWidth = r.valueAtIndexOrDefault(h.lineWidth, 0), o.strokeStyle = r.valueAtIndexOrDefault(h.color, 0);
                            var F = t.left, j = t.right + E, $ = t.top, W = t.bottom + E, H = r.aliasPixel(o.lineWidth);
                            g ? ($ = W = "top" === n.position ? t.bottom : t.top, $ += H, W += H) : (F = j = "left" === n.position ? t.right : t.left, F += H, j += H), o.beginPath(), o.moveTo(F, $), o.lineTo(j, W), o.stroke()
                        }
                    }
                }
            })
            ...
            var c = o.extend({
                initialize: function (e) {
                    ...
                    if (m ? (g.width = e.maxWidth, g.height = o ? 10 : 0) : (g.width = o ? 10 : 0, g.height = e.maxHeight), o) if (a.font = f, m) {
                        ...
                        var b = n.padding, x = e.columnWidths = [], w = n.padding, k = 0, C = 0, _ = u + b;
...
dropdownSelectors.on({
        ...
        d = function () {
            ...
            return _createClass(d, [{
                ...
                key: "updateOverlayOpacity", value: function (e) {
                    var t;
                    t = "left" === this.options.edge ? e / this.options.menuWidth : Math.abs((e - window.innerWidth) / this.options.menuWidth), this.$sidenavOverlay.velocity({opacity: t}, {
                        duration: 10,
                        queue: !1,
                ...
                key: "touchendEventHandler", value: function (e) {
                    if ("touchend" === e.type) {
                        ...
                        var n = this.calculateTouchVelocityX(), i = t.clientX, o = i - this.options.menuWidth,
                            r = i - this.options.menuWidth / 2;
                        o > 0 && (o = 0), r < 0 && (r = 0), "left" === this.options.edge ? (this.menuOut && n <= .3 || n < -.5 ? (0 !== o && this.translateMenuX([0, o], "300"), this.showSidenavOverlay()) : (!this.menuOut || n > .3) && (this.enableScrolling(), this.translateMenuX([-1 * this.options.menuWidth - 10, o], "200"), this.hideSidenavOverlay()), this.$dragTarget.css({
                            width: "10px",
                            right: "",
                            left: 0
                            ...
                            right: "",
                            left: 0
                        })) : (!this.menuOut || n < -.3) && (this.enableScrolling(), this.translateMenuX([this.options.menuWidth + 10, r], "200"), this.hideSidenavOverlay(), this.$dragTarget.css({
                            width: "10px",
                            right: 0,
                            left: ""
                        }))
                ...
                key: "panendEventHandler", value: function (e) {
                    if ("touch" === e.gesture.pointerType) {
                        var t = e.gesture.velocityX, n = e.gesture.center.x, i = n - this.options.menuWidth,
                            o = n - this.options.menuWidth / 2;
                        i > 0 && (i = 0), o < 0 && (o = 0), "left" === this.options.edge ? (this.menuOut && t <= .3 || t < -.5 ? (0 !== i && this.translateMenuX([0, i], "300"), this.showSidenavOverlay()) : (!this.menuOut || t > .3) && (this.enableScrolling(), this.translateMenuX([-1 * this.options.menuWidth - 10, i], "200"), this.hideSidenavOverlay()), this.$dragTarget.css({
                            width: "10px",
                            right: "",
                            left: 0
                ...
                key: "setMenuWidth", value: function () {
                    ...
                    this.options.menuWidth !== t && (this.$menu.css("width", this.options.menuWidth), n.css("width", this.options.menuWidth))
                }
            }, {
        ...
        return _createClass(t, [{
            ...
            key: "buildSingleOption", value: function (t, n) {
                var i = t.is(":disabled") ? "disabled" : "", o = "optgroup-option" === n ? "optgroup-option" : "",
                    r = t.data("icon"), a = t.data("fas") ? '<i class="fas fa-'.concat(t.data("fas"), '"></i> ') : "",
                    s = t.attr("class"), l = r ? '<img alt="" src="'.concat(r, '" class="').concat(s, '">') : "",
                    c = this.isMultiple ? '<input type="checkbox" class="form-check-input" '.concat(i, "/><label></label>") : "";
                this.$materialOptionsList.append(e('<li class="'.concat(i, " ").concat(o, '">').concat(l, '<span class="filtrable">').concat(c).concat(a).concat(t.html(), "</span></li>")))
            }
        }, {
            ...
            key: "_onEachMaterialOptionClick", value: function (t, n, i) {
                ...
                if (!o.hasClass("disabled") && !o.hasClass("optgroup")) {
                    ...
                    this._selectSingleOption(o), this.$nativeSelect.data("stop-refresh", !0), this.$nativeSelect.find("option").eq(t).prop("selected", r), this.$nativeSelect.removeData("stop-refresh"), this._triggerChangeOnNativeSelect(), "function" == typeof this.options && this.options()
                }
            }
        }, {
            ...
            key: "_onToggleAllClick", value: function () {
                ...
                e(n).prop("checked", i), this.$materialOptionsList.find("li:not(.optgroup):not(.disabled):not(.select-toggle-all)").each(function (n, o) {
                    var r = e(o).find('input[type="checkbox"]');
                    i && r.is(":checked") || !i && !r.is(":checked") || (t._isToggleAllPresent() && n++, r.prop("checked", i), t.$nativeSelect.find("option").eq(n).prop("selected", i), i ? e(o).removeClass("active") : e(o).addClass("active"), t._toggleSelectedValue(n), t._selectOption(o), t._setValueToMaterialSelect())
    ...
    function r(t, l, u, d) {
        ...
        var h = !1, f = {id: t.id || "P" + Math.abs(~~(Math.random() * new Date))},
            p = u ? e.extend(!0, {}, u.defaults, d) : d || {}, g = e.extend({}, r.klasses(), p.klass), m = e(t),
            v = function () {
                return this.start()
            }, y = v.prototype = {
                constructor: v, $node: m, start: function () {
                    return f && f.start ? y : (f.methods = {}, f.start = !0, f.open = !1, f.type = t.type, t.autofocus = t == c(), t.readOnly = !p.editable, t.id = t.id || f.id, "text" != t.type && (t.type = "text"), y.component = new u(y, p), y.$root = e('<div class="' + g.picker + '" id="' + t.id + '_root" />'), s(y.$root[0], "hidden", !0), y.$holder = e(b()).appendTo(y.$root), x(), p.formatSubmit && function () {
                        var n;
                        ...
                        m.data(l, y).addClass(g.input).val(m.data("value") ? y.get("select", p.format) : t.value), p.editable || m.on("focus." + f.id + " click." + f.id, (e = function (e) {
                            e.preventDefault(), y.open()
                        }, n = 300, function () {
                            var t = this, r = arguments, a = i && !o;
                            clearTimeout(o), o = setTimeout(function () {
                                o = null, i || e.apply(t, r)
                            }, n), a && e.apply(t, r)
                        })).on("keydown." + f.id, k);
                        var e, n, i, o;
        ...
        function x() {
            y.$holder.on({
                ...
                var t = e(this), n = t.data(), i = t.hasClass(g.navDisabled) || t.hasClass(g.disabled), o = c();
    ...
    o.prototype.set = function (e, t, n) {
        ...
        var t, n, o = this, r = o.settings, a = o.item, s = a.now, l = a.select, c = a.highlight, u = a.view,
            ...
            p = (t = (r.showWeekdaysFull ? r.weekdaysFull : r.weekdaysShort).slice(0), n = r.weekdaysFull.slice(0), r.firstDay && (t.push(t.shift()), n.push(n.shift())), i.node("thead", i.node("tr", i.group({
                ...
                return i.node("div", " ", r.klass["nav" + (e ? "Next" : "Prev")] + (e && u.year >= f.year && u.month >= f.month || !e && u.year <= h.year && u.month <= h.month ? " " + r.klass.navDisabled : ""), "data-nav=" + (e || -1) + " " + i.ariaAttr({
                    role: "button",
    ...
    function S(e, t) {
        var n, o, a = i(_), l = a.find(".clockpicker-plate"), c = a.find(".picker__holder"),
            f = a.find(".clockpicker-hours"), S = a.find(".clockpicker-minutes"),
            E = a.find(".clockpicker-am-pm-block"), A = "INPUT" === e.prop("tagName"), P = A ? e : e.find("input"),
            D = (P.prop("type"), i("label[for=" + P.attr("id") + "]")), I = this;
        if (this.id = (o = ++v + "", (n = "cp") ? n + o : o), this.element = e, this.holder = c, this.options = t, this.isAppended = !1, this.isShown = !1, this.currentView = "hours", this.isInput = A, this.input = P, this.label = D, this.popover = a, this.plate = l, this.hoursView = f, this.minutesView = S, this.amPmBlock = E, this.spanHours = a.find(".clockpicker-span-hours"), this.spanMinutes = a.find(".clockpicker-span-minutes"), this.spanAmPm = a.find(".clockpicker-span-am-pm"), this.footer = a.find(".picker__footer"), this.amOrPm = "", t.twelvehour) {
        ...
        t.darktheme && a.addClass("darktheme"), i('<button type="button" class="btn btn-flat clockpicker-button" tabindex="' + (t.twelvehour ? "3" : "1") + '">' + t.donetext + "</button>").click(i.proxy(this.done, this)).appendTo(this.footer), i('<button type="button" class="btn btn-flat clockpicker-button" tabindex="' + (t.twelvehour ? "4" : "2") + '">' + t.cleartext + "</button>").click(i.proxy(this.clearInput, this)).appendTo(this.footer), this.spanHours.click(i.proxy(this.toggleView, this, "hours")), this.spanMinutes.click(i.proxy(this.toggleView, this, "minutes")), P.on("focus.clockpicker click.clockpicker", g(i.proxy(this.show, this), 300));
        var M, L, N, R, F = i('<div class="clockpicker-tick"></div>');
        if (t.twelvehour) for (M = 0; M < 12; M += t.hourstep) L = F.clone(), N = M / 6 * Math.PI, R = b, L.css("font-size", "140%"), L.css({
            left: y + Math.sin(N) * R - w,
            top: y - Math.cos(N) * R - w
        }), L.html(0 === M ? 12 : M), f.append(L), L.on(u, W); else for (M = 0; M < 24; M += t.hourstep) {
            L = F.clone(), N = M / 6 * Math.PI;
            var j = M > 0 && M < 13;
            R = j ? x : b, L.css({
                left: y + Math.sin(N) * R - w,
                top: y - Math.cos(N) * R - w
            }), j && L.css("font-size", "120%"), L.html(0 === M ? "00" : M), f.append(L), L.on(u, W)
        }
        var $ = Math.max(t.minutestep, 5);
        for (M = 0; M < 60; M += $) for (M = 0; M < 60; M += 5) L = F.clone(), N = M / 30 * Math.PI, L.css({
            left: y + Math.sin(N) * b - w,
            top: y - Math.cos(N) * b - w
        }), L.css("font-size", "140%"), L.html(m(M)), S.append(L), L.on(u, W);
        ...
        function W(e, n) {
            ...
            if (!n || !(p < b - w || p > b + w)) {
                ...
                s && l.append(I.canvas), I.setHand(u, f, !n, !0), r.off(d).on(d, function (e) {
                    ...
                    (n || g) && o === u && s === f && I.setHand(o, s), "hours" === I.currentView ? I.toggleView("minutes", C / 2) : t.autoclose && (I.minutesView.addClass("clockpicker-dial-out"), setTimeout(function () {
                        I.done()
                    }, C / 2)), l.prepend(H), clearTimeout(m), I.popover.removeClass("clockpicker-moving"), r.off(d)
                })
            }
        }

        if (l.on(u, function (e) {
            0 === i(e.target).closest(".clockpicker-tick").length && W(e, !0)
        }), s) {
            var H = a.find(".clockpicker-canvas"), B = p("svg");
            ...
            var X = p("circle");
            X.setAttribute("class", "clockpicker-canvas-fg"), X.setAttribute("r", 5), V.appendChild(q), V.appendChild(Y), V.appendChild(X), V.appendChild(z), B.appendChild(V), H.append(B), this.hand = q, this.bg = Y, this.fg = X, this.bearing = z, this.g = V, this.canvas = H
        }
        T(this.options.init)
    }
    ...
    S.DEFAULTS = {
        ...
        if (!this.isShown) {
            ...
            }, 300)), r.on("keyup.clockpicker." + this.id, g(function (e) {
                27 === e.keyCode && t.hide()
            }, 300)), T(this.options.afterShow)
        }
    ...
    }, S.prototype.toggleView = function (e, t) {
        var n = !1;
    ...
    }, S.prototype.setHand = function (e, t, n, o) {
        ...
        function n() {
            ...
            if (o) "function" == typeof o[e] && o[e].apply(o, t); else {
                var r = i.extend({}, S.DEFAULTS, n.data(), "object" == typeof e && e);
                n.data("clockpicker", new S(n, r))
            }
        }
    ...
    return function (e, t, n, i) {
        ...
        o.extend(a, i);
        var s, l, c, u, d, h, f, p, g, m, v, y, b, x, w, k, C, _, S, T, E, A, P, D, I, O, M, L, N, R, F, j, $, W, H, B,
            V, z, q, Y, X, U, K, Q, G, Z, J, ee, te, ne, ie, oe, re, ae, se, le = {x: 0, y: 0}, ce = {x: 0, y: 0},
            ...
            xe = function (e, t) {
                ...
                e && (X || Y || te || B) && (e.preventDefault(), e.stopPropagation())
            }, Ve = function () {
                r.setScrollOffset(0, o.getScrollY())
            }, ze = {}, qe = 0, Ye = function (e) {
                ze[e] && (ze[e].raf && O(ze[e].raf), qe--, delete ze[e])
            }, Xe = function (e) {
                ...
                shout: _e, listen: Ce, viewportSize: de, options: a, isMainScrollAnimating: function () {
                    ...
                    if (!s && !l) {
                        var n;
                        r.framework = o, r.template = e, r.bg = o.getChildByClass(e, "pswp__bg"), M = e.className, s = !0, F = o.detectFeatures(), I = F.raf, O = F.caf, A = F.transform, N = F.oldIE, r.scrollWrap = o.getChildByClass(e, "pswp__scroll-wrap"), r.container = o.getChildByClass(r.scrollWrap, "pswp__container"), d = r.container.style, r.itemHolders = k = [{
                        ...
                        }(), g = {resize: r.updateSize, scroll: Ve, keydown: He, click: Be};
                        ...
                        t && (r.ui = new t(r, o)).init(), _e("firstUpdate"), u = u || a.index || 0, (isNaN(u) || 0 > u || u >= Wt()) && (u = 0), r.currItem = $t(u), (F.isOldIOSPhone || F.isOldAndroid) && (me = !1), e.setAttribute("aria-hidden", "false"), a.modal && (me ? e.style.position = "fixed" : (e.style.position = "absolute", e.style.top = o.getScrollY() + "px")), void 0 === R && (_e("initialLayout"), R = L = o.getScrollY());
                        var c = "pswp--open ";
                        for (a.mainClass && (c += a.mainClass + " "), a.showHideOpacity && (c += "pswp--animate_opacity "), c += D ? "pswp--touch" : "pswp--notouch", c += F.animationName ? " pswp--css_animation" : "", c += F.svg ? " pswp--svg" : "", o.addClass(e, c), r.updateSize(), h = -1, ge = null, n = 0; 3 > n; n++) De((n + h) * pe.x, k[n].el.style);
                        N || o.bind(r.scrollWrap, p, r), Ce("initialZoomInEnd", function () {
                            r.setContent(k[0], u - 1), r.setContent(k[2], u + 1), k[0].el.style.display = k[2].el.style.display = "block", a.focus && e.focus(), o.bind(document, "keydown", r), F.transform && o.bind(r.scrollWrap, "click", r), a.mouseUsed || o.bind(document, "mousemove", Re), o.bind(window, "resize scroll", r), _e("bindEvents")
                        }), r.setContent(k[1], u), r.updateCurrItem(), _e("afterInit"), me || (x = setInterval(function () {
                            qe || z || G || m !== r.currItem.initialZoomLevel || r.updateSize()
                        }, 1e3)), o.addClass(e, "pswp--visible")
                    }
                }, close: function () {
                    s && (s = !1, l = !0, _e("close"), o.unbind(window, "resize", r), o.unbind(window, "scroll", g.scroll), o.unbind(document, "keydown", r), o.unbind(document, "mousemove", Re), F.transform && o.unbind(r.scrollWrap, "click", r), z && o.unbind(window, f, r), _e("unbindEvents"), Ht(r.currItem, null, !0, r.destroy))
                }, destroy: function () {
                    _e("destroy"), Nt && clearTimeout(Nt), e.setAttribute("aria-hidden", "true"), e.className = M, x && clearInterval(x), o.unbind(r.scrollWrap, p, r), o.unbind(window, "scroll", r), ft(), Ue(), ke = null
                    ...
                    var t = (e = we(e)) - u;
                    ge = t, u = e, r.currItem = $t(u), he -= t, Ie(pe.x * he), Ue(), te = !1, r.updateCurrItem()
                }, next: function () {
                    r.goTo(u + 1)
                }, prev: function () {
                    r.goTo(u - 1)
                    ...
                    J = r.currItem.bounds, v = m = r.currItem.initialZoomLevel, ue.x = J.center.x, ue.y = J.center.y, e && _e("afterChange")
                    ...
                    if (0 !== ge) {
                        var t, n = Math.abs(ge);
                        if (!(e && 2 > n)) {
                            r.currItem = $t(u), be = !1, _e("beforeChange", ge), n >= 3 && (h += ge + (ge > 0 ? -3 : 3), n = 3);
                            for (var i = 0; n > i; i++) ge > 0 ? (t = k.shift(), k[2] = t, De((++h + 2) * pe.x, t.el.style), r.setContent(t, u - n + i + 1 + 1)) : (t = k.pop(), k.unshift(t), De(--h * pe.x, t.el.style), r.setContent(t, u + n - i - 1 - 1));
                            if (ee && 1 === Math.abs(ge)) {
                                var o = $t(C);
                                o.initialZoomLevel !== m && (qt(o, de), Kt(o), Pe(o))
                            }
                            ge = 0, r.updateCurrZoomItem(), C = u, _e("afterChange")
                        }
                    }
                    ...
                    if (de.x = r.scrollWrap.clientWidth, de.y = r.scrollWrap.clientHeight, Ve(), pe.x = de.x + Math.round(de.x * a.spacing), pe.y = de.y, Ie(pe.x * he), _e("beforeResize"), void 0 !== h) {
                        for (var i, s, l, c = 0; 3 > c; c++) i = k[c], De((c + h) * pe.x, i.el.style), l = u + c - 1, a.loop && Wt() > 2 && (l = we(l)), (s = $t(l)) && (w || s.needsUpdate || !s.bounds) ? (r.cleanSlide(s), r.setContent(i, l), 1 === c && (r.currItem = s, r.updateCurrZoomItem(!0)), s.needsUpdate = !1) : -1 === i.index && l >= 0 && r.setContent(i, l), s && s.container && (qt(s, de), Kt(s), Pe(s));
                        w = !1
                    }
                    v = m = r.currItem.initialZoomLevel, (J = r.currItem.bounds) && (ue.x = J.center.x, ue.y = J.center.y, Ae(!0)), _e("resize")
                }, zoomTo: function (e, t, n, i, r) {
                    t && (v = m, ut.x = Math.abs(t.x) - ue.x, ut.y = Math.abs(t.y) - ue.y, Me(ce, ue));
                    var a = Fe(e, !1), s = {};
            ...
            lt = 0, ct = {x: 0, y: 0}, ut = {x: 0, y: 0}, dt = {x: 0, y: 0}, ht = function (e, t) {
                ...
                return P ? (se = 0, nt.forEach(function (e) {
                ...
                return n = l > J.min[e] || l < J.max[e] ? a.panEndFriction : 1, l = ue[e] + t[e] * n, !a.allowPanToNext && m !== r.currItem.initialZoomLevel || (ee ? "h" !== ne || "x" !== e || Y || (c ? (l > J.min[e] && (n = a.panEndFriction, J.min[e], i = J.min[e] - ce[e]), (0 >= i || 0 > d) && Wt() > 1 ? (s = u, 0 > d && u > it.x && (s = it.x)) : J.min.x !== J.max.x && (o = l)) : (l < J.max[e] && (n = a.panEndFriction, J.max[e], i = ce[e] - J.max[e]), (0 >= i || d > 0) && Wt() > 1 ? (s = u, d > 0 && u < it.x && (s = it.x)) : J.min.x !== J.max.x && (o = l))) : s = u, "x" !== e) ? void(te || K || m > r.currItem.fitRatio && (ue[e] += t[e] * n)) : (void 0 !== s && (Ie(s, !0), K = s !== it.x), J.min.x !== J.max.x && (void 0 !== o ? ue.x = o : K || (ue.x += t.x * n)), void 0 !== s)
            }, Tt = function (e) {
                if (!("mousedown" === e.type && e.button > 0)) {
                    if (jt) return void e.preventDefault();
                    if (!V || "mousedown" !== e.type) {
                        if (vt(e, !0) && e.preventDefault(), _e("pointerDown"), P) {
                            var t = o.arraySearch(nt, e.pointerId, "id");
                            0 > t && (t = nt.length), nt[t] = {x: e.pageX, y: e.pageY, id: e.pointerId}
                        }
                        var n = _t(e), i = n.length;
                        Q = null, Ue(), z && 1 !== i || (z = ie = !0, o.bind(window, f, r), H = ae = oe = B = K = X = q = Y = !1, ne = null, _e("firstTouchStart", n), Me(ce, ue), le.x = le.y = 0, Me(et, n[0]), Me(tt, et), it.x = pe.x * he, ot = [{
                            x: et.x,
                            y: et.y
                        }], $ = j = Se(), Fe(m, !0), ft(), pt()), !G && i > 1 && !te && !K && (v = m, Y = !1, G = q = !0, le.y = le.x = 0, Me(ce, ue), Me(Ge, n[0]), Me(Ze, n[1]), bt(Ge, Ze, dt), ut.x = Math.abs(dt.x) - ue.x, ut.y = Math.abs(dt.y) - ue.y, Z = ht(Ge, Ze))
                    }
                }
            }, Et = function (e) {
                ...
                if (z) {
                    var i = _t(e);
                    if (ne || X || G) Q = i; else if (ct.x !== pe.x * he) ne = "h"; else {
                ...
                if (Q) {
                    var e = Q.length;
                    if (0 !== e) if (Me(Ge, Q[0]), Je.x = Ge.x - et.x, Je.y = Ge.y - et.y, G && e > 1) {
                        if (et.x = Ge.x, et.y = Ge.y, !Je.x && !Je.y && function (e, t) {
                            return e.x === t.x && e.y === t.y
                        }(Q[1], Ze)) return;
                        Me(Ze, Q[1]), Y || (Y = !0, _e("zoomGestureStarted"));
                        var t = ht(Ge, Ze), n = Mt(t);
                        ...
                        if (o > n) if (a.pinchToClose && !ae && v <= r.currItem.initialZoomLevel) {
                            var l = 1 - (o - n) / (o / 1.2);
                            Te(l), _e("onPinchClose", l), oe = !0
                        } else (i = (o - n) / o) > 1 && (i = 1), n = o - i * (o / 3); else n > s && ((i = (n - s) / (6 * o)) > 1 && (i = 1), n = s + i * o);
                        0 > i && (i = 0), bt(Ge, Ze, st), le.x += st.x - dt.x, le.y += st.y - dt.y, Me(dt, st), ue.x = Oe("x", n), ue.y = Oe("y", n), H = n > m, m = n, Ae()
                    } else {
                        if (!ne) return;
                        ...
                        if ("v" === ne && a.closeOnVerticalDrag && "fit" === a.scaleMode && m === r.currItem.initialZoomLevel) {
                            le.y += Je.y, ue.y += Je.y;
                            var c = xt();
                            return B = !0, _e("onVerticalDrag", c), Te(c), void Ae()
                        }
                        (function (e, t, n) {
                            if (e - $ > 50) {
                        ...
                        })(Se(), Ge.x, Ge.y), X = !0, J = r.currItem.bounds, St("x", Je) || (St("y", Je), Le(ue), Ae())
                    }
                }
            }, Pt = function (e) {
                if (F.isOldAndroid) {
                ...
                var t;
                if (_e("pointerUp"), vt(e, !1) && e.preventDefault(), P) {
                ...
                1 === l && Me(tt, s[0]), 0 !== l || ne || te || (t || ("mouseup" === e.type ? t = {
                    x: e.pageX,
                    y: e.pageY,
                    type: "mouse"
                ...
                var c = -1;
                if (0 === l && (z = !1, o.unbind(window, f, r), ft(), G ? c = 0 : -1 !== lt && (c = Se() - lt)), lt = 1 === l ? Se() : -1, i = -1 !== c && 150 > c ? "zoom" : "swipe", G && 2 > l && (G = !1, 1 === l && (i = "zoomPointerUp"), _e("zoomGestureEnded")), Q = null, X || Y || te || B) if (Ue(), W || (W = Dt()), W.calculateSwipeSpeed("x"), B) if (xt() < a.verticalDragRange) r.close(); else {
                    var u = ue.y, d = re;
                    ...
                    if (!te) return "swipe" !== i ? void Lt() : void(!K && m > r.currItem.fitRatio && It(W))
                }
            }, Dt = function () {
                var e, t, n = {
                    lastFlickOffset: {},
                    ...
                    calculateSwipeSpeed: function (i) {
                        ot.length > 1 ? (e = Se() - $ + 50, t = ot[ot.length - 2][i]) : (e = Se() - j, t = tt[i]), n.lastFlickOffset[i] = et[i] - t, n.lastFlickDist[i] = Math.abs(n.lastFlickOffset[i]), n.lastFlickDist[i] > 20 ? n.lastFlickSpeed[i] = n.lastFlickOffset[i] / e : n.lastFlickSpeed[i] = 0, Math.abs(n.lastFlickSpeed[i]) < .1 && (n.lastFlickSpeed[i] = 0), n.slowDownRatio[i] = .95, n.slowDownRatioReverse[i] = 1 - n.slowDownRatio[i], n.speedDecelerationRatio[i] = 1
                    },
                ...
                i && (0 > (u += i) ? (u = a.loop ? Wt() - 1 : 0, s = !0) : u >= Wt() && (u = a.loop ? 0 : Wt() - 1, s = !0), (!s || a.loop) && (ge += i, he -= i, n = !0));
                var d, h = pe.x * he, f = Math.abs(h - ct.x);
                return n || h > ct.x == t.lastFlickSpeed.x > 0 ? (d = Math.abs(t.lastFlickSpeed.x) > 0 ? f / Math.abs(t.lastFlickSpeed.x) : 333, d = Math.min(d, 400), d = Math.max(d, 250)) : d = 333, at === u && (n = !1), te = !0, _e("mainScrollAnimStart"), Ke("mainScroll", ct.x, h, d, o.easing.cubic.out, Ie, function () {
                    Ue(), te = !1, at = -1, (n || at !== u) && r.updateCurrItem(), _e("mainScrollAnimComplete")
                ...
                t > m ? e = t : m > n && (e = n);
                var i, a = re;
                return oe && !H && !ae && t > m ? (r.close(), !0) : (oe && (i = function (e) {
                    Te((1 - a) * e + a)
            ...
            publicMethods: {
                initGestures: function () {
                    var e = function (e, t, n, i, o) {
                        _ = e + t, S = e + n, T = e + i, E = o ? e + o : ""
                    };
                    (P = F.pointerEvent) && F.touch && (F.touch = !1), P ? navigator.pointerEnabled ? e("pointer", "down", "move", "up", "cancel") : e("MSPointer", "Down", "Move", "Up", "Cancel") : F.touch ? (e("touch", "start", "move", "end", "cancel"), D = !0) : e("mouse", "down", "move", "up"), f = S + " " + T + " " + E, p = _, P && !D && (D = navigator.maxTouchPoints > 1 || navigator.msMaxTouchPoints > 1), r.likelyTouchDevice = D, g[_] = Tt, g[S] = Et, g[T] = Pt, E && (g[E] = g[T]), F.touch && (p += " mousedown", f += " mousemove mouseup", g.mousedown = g[_], g.mousemove = g[S], g.mouseup = g[T]), D || (a.allowPanToNext = !1)
                }
            }
        });
        var Nt, Rt, Ft, jt, $t, Wt, Ht = function (t, n, i, s) {
            var l;
            Nt && clearTimeout(Nt), jt = !0, Ft = !0, t.initialLayout ? (l = t.initialLayout, t.initialLayout = null) : l = a.getThumbBoundsFn && a.getThumbBoundsFn(u);
            var d = i ? a.hideAnimationDuration : a.showAnimationDuration, h = function () {
                Ye("initialZoom"), i ? (r.template.removeAttribute("style"), r.bg.removeAttribute("style")) : (Te(1), n && (n.style.display = "block"), o.addClass(e, "pswp--animated-in"), _e("initialZoom" + (i ? "OutEnd" : "InEnd"))), s && s(), jt = !1
            };
            if (!d || !l || void 0 === l.x) return _e("initialZoom" + (i ? "Out" : "In")), m = t.initialZoomLevel, Me(ue, t.initialPosition), Ae(), e.style.opacity = i ? 0 : 1, Te(1), void(d ? setTimeout(function () {
                h()
            }, d) : h());
            !function () {
                var n = c, s = !r.currItem.src || r.currItem.loadError || a.showHideOpacity;
                t.miniImg && (t.miniImg.style.webkitBackfaceVisibility = "hidden"), i || (m = l.w / t.w, ue.x = l.x, ue.y = l.y - L, r[s ? "template" : "bg"].style.opacity = .001, Ae()), Xe("initialZoom"), i && !n && o.removeClass(e, "pswp--animated-in"), s && (i ? o[(n ? "remove" : "add") + "Class"](e, "pswp--animate_opacity") : setTimeout(function () {
                    o.addClass(e, "pswp--animate_opacity")
                }, 30)), Nt = setTimeout(function () {
                    if (_e("initialZoom" + (i ? "Out" : "In")), i) {
                        var r = l.w / t.w, a = {x: ue.x, y: ue.y}, c = m, u = re, f = function (t) {
                            1 === t ? (m = r, ue.x = l.x, ue.y = l.y - R) : (m = (r - c) * t + c, ue.x = (l.x - a.x) * t + a.x, ue.y = (l.y - R - a.y) * t + a.y), Ae(), s ? e.style.opacity = 1 - t : Te(u - t * u)
                        };
                        n ? Ke("initialZoom", 0, 1, d, o.easing.cubic.out, f, h) : (f(1), Nt = setTimeout(h, d + 20))
                    } else m = t.initialZoomLevel, Me(ue, t.initialPosition), Ae(), Te(1), s ? e.style.opacity = 1 : Te(1), Nt = setTimeout(h, d + 20)
                }, i ? 25 : 90)
            }()
        }, Bt = {}, Vt = [], zt = {
            index: 0,
            ...
            if (e.src && !e.loadError) {
                ...
                if (i && (e.vGap || (e.vGap = {
                    top: 0,
                    bottom: 0
                }), _e("parseVerticalMargin", e)), Bt.x = t.x, Bt.y = t.y - e.vGap.top - e.vGap.bottom, i) {
        ...
        xe("Controller", {
            publicMethods: {
                lazyLoadItem: function (e) {
                    e = we(e);
                    var t = $t(e);
                    t && (!t.loaded && !t.loading || w) && (_e("gettingData", e, t), t.src && Xt(t))
                }, initController: function () {
                    o.extend(a, zt, !0), r.items = Rt = n, $t = r.getItemAt, Wt = a.getNumItemsFn, a.loop, Wt() < 3 && (a.loop = !1), Ce("beforeChange", function (e) {
                    ...
                    if (l) {
                        ...
                        if (!l.src && l.html && (l.html.tagName ? c.appendChild(l.html) : c.innerHTML = l.html), Ut(l), qt(l, de), !l.src || l.loadError || l.loaded) l.src && !l.loadError && ((i = o.createEl("pswp__img", "img")).style.opacity = 1, i.src = l.src, Kt(l, i), Yt(0, l, c, i)); else {
                            if (l.loadComplete = function (n) {
                                if (s) {
                                    if (e && e.index === t) {
                                        if (Ut(n, !0)) return n.loadComplete = n.img = null, qt(n, de), Pe(n), void(e.index === u && r.updateCurrZoomItem());
                        ...
                        Ft || t !== u ? Pe(l) : (ee = c.style, Ht(l, i || l.img)), e.el.innerHTML = "", e.el.appendChild(c)
                    } else e.el.innerHTML = ""
            ...
            publicMethods: {
                initTap: function () {
                    ...
                    if (t && !X && !q && !qe) {
                        ...
                        Me(Jt, n), Gt = setTimeout(function () {
                            en(e, t), Gt = null
                        }, 300)
                    }
                }
    ...
    "use strict";
    return function (e, t) {
        var n, i, o, r, a, s, l, c, u, d, h, f, p, g, m, v, y, b, x = this, w = !1, k = !0, C = !0, _ = {
        ...
        x.init = function () {
            t.extend(e.options, _, !0), m = e.options, i = t.getChildByClass(e.scrollWrap, "pswp__ui"), d = e.listen, function () {
                ...
                t.bind(i, "pswpTap click", S), t.bind(e.scrollWrap, "pswpTap", x.onGlobalTap), e.likelyTouchDevice || t.bind(e.scrollWrap, "mouseover", x.onMouseOver)
            }), d("unbindEvents", function () {
                C || D(), y && clearInterval(y), t.unbind(document, "mouseout", R), t.unbind(document, "mousemove", N), t.unbind(i, "pswpTap click", S), t.unbind(e.scrollWrap, "pswpTap", x.onGlobalTap), t.unbind(e.scrollWrap, "mouseover", x.onMouseOver), n && (t.unbind(document, n.eventK, x.updateFullscreen), n.isFullscreen() && (m.hideAnimationDuration = 0, n.exit()), n = null)
            }), d("destroy", function () {
            ...
            k && e.currItem ? (x.updateIndexIndicator(), m.captionEl && (m.addCaptionHTMLFn(e.currItem, o), E(o, "caption--empty", !e.currItem.title)), w = !0) : w = !1, C || D(), A()
            ...
            } else if (m.tapToToggleControls && (k ? x.hideControls() : x.showControls()), m.tapToClose && (t.hasClass(i, "pswp__img") || M(i))) return void e.close()
        }, x.onMouseOver = function (e) {
            var t = (e = e || window.event).target || e.srcElement;
            E(i, "ui--over-close", M(t))
    ...
    11: [function (e, t, n) {
        ...
        t.exports = function (e) {
            ...
            (function (e, t) {
                ...
                var r = null, l = null, c = function (t) {
                ...
                t.event.bind(t.scrollbarX, "mousedown", function (n) {
                    l = n.pageX, r = i.toInt(o.css(t.scrollbarX, "left")) * t.railXRatio, i.startScrolling(e, "x"), t.event.bind(t.ownerDocument, "mousemove", c), t.event.once(t.ownerDocument, "mouseup", u), n.stopPropagation(), n.preventDefault()
                })
            })(e, t), function (e, t) {
                function n(n) {
                ...
                t.event.bind(t.scrollbarY, "mousedown", function (n) {
                    l = n.pageY, r = i.toInt(o.css(t.scrollbarY, "top")) * t.railYRatio, i.startScrolling(e, "y"), t.event.bind(t.ownerDocument, "mousemove", c), t.event.once(t.ownerDocument, "mouseup", u), n.stopPropagation(), n.preventDefault()
                })
            }(e, t)
        }
    }, {
        ...
        function i(e, t) {
            ...
            t.event.bind(t.ownerDocument, "selectionchange", function () {
                ...
                if (u) {
                    ...
                    r.x < a.left + 3 ? (c.left = -5, o.startScrolling(e, "x")) : r.x > a.right - 3 ? (c.left = 5, o.startScrolling(e, "x")) : c.left = 0, r.y < a.top + 3 ? (c.top = a.top + 3 - r.y < 5 ? -5 : -20, o.startScrolling(e, "y")) : r.y > a.bottom - 3 ? (c.top = r.y - a.bottom + 3 < 5 ? 5 : 20, o.startScrolling(e, "y")) : c.top = 0, 0 === c.top && 0 === c.left ? i() : n()
                }
            })
        }
            ...
            (i.env.supportsTouch || i.env.supportsIePointer) && function (e, t, n, i) {
                ...
                function p(e) {
                    if (!w && t.settings.swipePropagation && f(e), !x && w && h(e)) {
                        ...
                        c > 0 && (y.x = o / c, y.y = r / c, v = a), s(o, r) && (e.stopPropagation(), e.preventDefault())
                    }
                }
...
!function (e) {
    ...
    e(".input-default-wrapper").on("change", ".input-default-js", function (t) {
        var n = e(t.target), i = n.next("label"), o = n[0].files, r = "";
        o && o.length > 1 ? r = (n.attr("data-multiple-target") || "").replace("{target}", o.length) : t.target.value && (r = t.target.value.split("\\").pop()), r ? i.find(".span-choose-file").html(r) : i.html(i.html())
    })
}(jQuery);
                        ...
                        for (var b = o, x = r; b < t.length; x += t[b].length, ++b) {
                            ...
                            if (!(w instanceof l)) {
                                if (g && b != t.length - 1) {
                                    ...
                                    for (var k = E.index + (p ? E[1].length : 0), C = E.index + E[0].length, _ = b, S = x, T = t.length; _ < T && (S < C || !t[_].type && !t[_ - 1].greedy); ++_) k >= (S += t[_].length) && (++b, x = S);
                                    if (t[b] instanceof l) continue;
                                    A = _ - b, w = e.slice(x, S), E.index -= x
                                } else {
                                    h.lastIndex = 0;
                                    var E = h.exec(w), A = 1
                                }
                                if (E) {
                                    ...
                                    var P = w.slice(0, k), D = w.slice(C), I = [b, A];
                                    P && (++b, x += P.length, I.push(P));
                                    var O = new l(c, f ? n.tokenize(E, f) : E, v, E, g);
                                    if (I.push(O), D && I.push(D), Array.prototype.splice.apply(t, I), 1 != A && n.matchGrammar(e, t, i, b, x, !0, c), a) break
                                } else if (a) break
                            }
                        }
                    }
